...
const EXERCISE_KEY_MAP: Record<string, ExerciseId> = {
  ...
  alternatingkneeraises: ExerciseId.ALTERNATING_KNEE_RAISES,
  "alternating-knee-raises": ExerciseId.ALTERNATING_KNEE_RAISES,
  kneeraises: ExerciseId.ALTERNATING_KNEE_RAISES,
  kneeraise: ExerciseId.ALTERNATING_KNEE_RAISES,
  "knee-raises": ExerciseId.ALTERNATING_KNEE_RAISES,
  "knee-raise": ExerciseId.ALTERNATING_KNEE_RAISES,
  elevacionesrodilla: ExerciseId.ALTERNATING_KNEE_RAISES,
  elevacionrodilla: ExerciseId.ALTERNATING_KNEE_RAISES,
  "elevaciones-rodilla": ExerciseId.ALTERNATING_KNEE_RAISES,
  elevacionesrodillaalternadas: ExerciseId.ALTERNATING_KNEE_RAISES,
  "elevaciones-rodilla-alternadas": ExerciseId.ALTERNATING_KNEE_RAISES,
  standingchestfly: ExerciseId.STANDING_CHEST_FLY,
  "standing-chest-fly": ExerciseId.STANDING_CHEST_FLY,
  chestfly: ExerciseId.STANDING_CHEST_FLY,
  "chest-fly": ExerciseId.STANDING_CHEST_FLY,
  chestflys: ExerciseId.STANDING_CHEST_FLY,
  aperturas: ExerciseId.STANDING_CHEST_FLY,
  aperturaspecho: ExerciseId.STANDING_CHEST_FLY,
  "aperturas-pecho": ExerciseId.STANDING_CHEST_FLY,
  aperturasdepiecho: ExerciseId.STANDING_CHEST_FLY,
  mariposa: ExerciseId.STANDING_CHEST_FLY,
  mariposapecho: ExerciseId.STANDING_CHEST_FLY,
};
